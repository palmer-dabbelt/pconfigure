...
\subsection{\texttt{kconfig}: Linux's Build System}
...
\subsection{\texttt{buildroot}: Buildroot}
...
\texttt{scripts/config}, and the build description is a
\texttt{.mk} file per package rather than a \texttt{Makefile} per
directory.  It recognizes a directory with a \texttt{Config.in} and a
...
same dependency guess.  \texttt{--defconfig} and \texttt{--configure}
mean what they mean there, and there is one more option:
