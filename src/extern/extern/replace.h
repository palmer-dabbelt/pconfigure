...
/* FIXME: I have just hard-coded these. */
#if 0
...
int rep_vasprintf(char **ptr, const char *format,
...
#define vsnprintf rep_vsnprintf
     int rep_vsnprintf(char *, size_t, const char *,
...
#define vsyslog rep_vsyslog
     void rep_vsyslog(int facility_priority, const char *format,
                      va_list arglist) PRINTF_ATTRIBUTE(2, 0);
#endif
#endif
...
#define pread rep_pread
     ssize_t rep_pread(int __fd, void *__buf, size_t __nbytes,
                       off_t __offset);
...
#define pwrite rep_pwrite
     ssize_t rep_pwrite(int __fd, const void *__buf, size_t __nbytes,
                        off_t __offset);
...
/* FIXME: I've just manually commented this out... */
#if 0
#ifndef HAVE_USLEEP
