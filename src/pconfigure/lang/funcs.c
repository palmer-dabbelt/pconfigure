                               ...
                               void *arg, char **dirs, char **defines)
{
    ...
    f.func = func;
    f.arg = arg;
    pinclude_list(full_path, &printf_wrap_str, &f, (const char **)dirs, (const char **)defines, true);
}
                               ...
                               void *arg, char **dirs, char **defines)
{
    ...
    f.func = func;
    f.arg = arg;
    pinclude_list(full_path, &string_wrap_str, &f, (const char **)dirs, (const char **)defines, true);
}
